...
public:
    ...
    void update(float deltaTime, Entity *player, Map *map, 
        Entity **collidableEntities, int collisionCheckCount); // Needed to make change here due to a memory error with my textures 
    void render();
    ...
    bool isColliding(Entity *other) const; // Moved here for now 
